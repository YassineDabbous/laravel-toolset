...
// USAGE
function exportDbToSeeder(){
    $export = new Export('localhost','ysn_feed','r00t3r','ansah10');
    $export->generateExport(
        ['categories', 'paths', 'locations', 'radios'], // null equals "All Tables" ( $this->getAllTableNames() )
        base_path('/database/seeders'), // if null './database/seeds' is applied
